...
export class ElizaScriptBuilder implements ScriptTemplate {
  ...
  public compileToString(): string {
    ...
    script += 'key: sorry\n';
    script += '  decomp: *@sad[*]*\n';
    script += '    reasmb: 何かあったのでしょうか、 (2)ことについて、もう少し話してください\n';
    script += '    reasmb: やはり (2)ことにならない可能性は少ないでしょうか ?\n';
    script += '    reasmb: やはり (2)となるのは残念です。\n';
    script += '    reasmb: あなたから (2)となる原因も聞かせてもらえますか ?\n';
    script += 'key: i-am\n';
    script += '  decomp: *ことで@happy[*]*\n';
    script += '    reasmb: ほんとうに (2) ? 私が何かやったのですか？\n';
    script += '    reasmb: 今は何が (1) ようにさせましたか ?\n';
    script += '    reasmb: なぜ突然 (1) ことになったのでしょうか?\n';
    script += '  decomp: *@happy[*]*\n';
    script += '    reasmb: ほんとうに (2) ? 私が何かやったのですか？\n';
    script += '    reasmb: 今は何か嬉しいことをされましたか ?\n';
    script += '    reasmb: なぜ突然嬉しくなったのでしょうか ？\n';
